...
enum{COMPOUND = -5, PRIME, NEGATIVE, SPECIAL, INVALID};
 ...
 * @param value Es el valor que tendrá la entrada.
 * @param category Es la categoria de la entrada (primo, negativo o compuesto).
 ...
 * @brief Inicializa los campos del struct
 * @param entrada Es la dirección de memoria donde se encuentra el registro que se desea inicializar.
 * @param category Es la categoria de la entrada (texto o fuera de rango).
 * @return Código de error:
 * 0 si se realizó la inicialización
 * 1 si no se realizó la inicialización
